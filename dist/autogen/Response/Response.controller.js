...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve multiple Responses' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ResponseController.prototype, "getMany", null);
__decorate([
    (0, crud_1.Override)('getOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a single Response' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a single Response' }),
    (0, swagger_1.ApiBody)({
        type: Response_dto_1.ResponseCreate,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Response_dto_1.Response]),
    __metadata("design:returntype", void 0)
], ResponseController.prototype, "create", null);
__decorate([
    (0, crud_1.Override)('createManyBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create multipleResponses' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], ResponseController.prototype, "createMany", null);
__decorate([
    (0, crud_1.Override)('updateOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a single Response' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Response_dto_1.Response]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Replace a single Response' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Response_dto_1.Response]),
    __metadata("design:returntype", void 0)
], ResponseController.prototype, "replace", null);
__decorate([
    (0, crud_1.Override)('deleteOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a single Response' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.ResponseController = ResponseController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: Response_dto_1.Response,
        },
        dto: {
            create: Response_dto_1.ResponseCreate,
            update: Response_dto_1.Response,
            replace: Response_dto_1.Response,
        },
        query: {
            limit: 5,
            alwaysPaginate: true,
